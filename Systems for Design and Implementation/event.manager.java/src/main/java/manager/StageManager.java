...
public class StageManager {
     ...
     */
    public void switchScene(final ViewType type, final Connection connection) {
        Parent root = getRootNode(type.getFXMLFile(), connection);
     ...
     */
    private Parent getRootNode(String fxmlFilePath, final Connection connection) {
        Parent root = null;
        try {
            root = loader.load(fxmlFilePath, connection);
