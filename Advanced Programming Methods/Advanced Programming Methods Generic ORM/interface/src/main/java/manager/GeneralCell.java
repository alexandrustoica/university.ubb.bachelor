...
public class GeneralCell<T extends Idable<?>> extends ListCell<T> {
    ...
    protected void updateItem(T item, boolean empty) {
        ...
        setGraphic((item != null && !empty) ? this.getItemGraphic(item) : null);
    }
    ...
    private Label createLabel(T item) {
        return new Label(provider.apply(item));
    }
